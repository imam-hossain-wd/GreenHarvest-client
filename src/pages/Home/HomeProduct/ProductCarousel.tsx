...
//   return (
//     <div className="swiper-container relative w-[90%] mx-auto mt-16">
...
//               <div className="bg-white shadow-xl rounded w-72 h-80 py-4 px-2 my-10" style={{ border: "1px solid #A8A8A8" }}>
//                 <div className="flex justify-around">
//                   <p
//                     style={{ border: "1px sloid #37B149" }}
//                     className="text-sm text-xs border border-primary text-white bg-primary px-3 py-1  rounded-full"
//                   >
//                     50% OFF
//                   </p>
//                   <div>
